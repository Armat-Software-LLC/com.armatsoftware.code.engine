...
{
    /// <summary>
    /// Add the default storage implementation of the IActionRepository to the service collection
    /// and use it for managing actions
    /// </summary>
    /// <param name="services"></param>
    /// <param name="options"></param>
    public static void UseCodeEngineDefaultFileStorage(this IServiceCollection services, FileStorageOptions options)
    {
