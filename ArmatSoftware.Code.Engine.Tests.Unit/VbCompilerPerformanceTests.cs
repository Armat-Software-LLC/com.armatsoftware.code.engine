...
internal class VbCompilerPerformanceTests : CompilerPerformanceTestBase<CompilerPerformanceTestSubject>
{
    [SetUp]
    public void Init()
    {
    ...
    private void BuildMultiActionExecutor(int n)
    {
        ...
        for (var index = 0; index < n; index++)
        {
            ...
            {
                Name = $"Action{index}",
                Code = $"Dim result = {Operations[index, 0]} + {Operations[index, 1]}"
            });
        }
